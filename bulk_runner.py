...
mesa_model.generate_data_parametric_exploration("end_report.csv", param_grid = all_params, repeats_per_setting = 40, change_landscape_seed = True, intention = "w", skip_to = 0)